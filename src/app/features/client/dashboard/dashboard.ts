...
@Component({
  ...
  imports: [CommonModule, StatCard, DataTable, Pagination, OrderModal, OrderTrackingModal],
...
export class Dashboard implements OnInit {
  ...
  columns: TableColumn[] = [
    ...
    { key: 'container.port_of_loading_location_name', label: 'Puerto de Origen', type: 'text' },
    { key: 'container.destination_port_location_name', label: 'Puerto de Destino', type: 'text' }
  ];
